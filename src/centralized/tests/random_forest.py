...
y_test_pred = rf_model.predict(test_dataloader.features)
y_val_pred = rf_model.predict(val_dataloader.features)
...
y_test_prob = rf_model.predict_proba(test_dataloader.features)[:, 1]
y_val_prob = rf_model.predict_proba(val_dataloader.features)[:, 1]
...
train_metrics = get_metrics(train_dataloader.labels, rf_model.predict(train_dataloader.features))
